# 0 "safe029_power.opt_pso.opt_rmo.opt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "safe029_power.opt_pso.opt_rmo.opt.c"
...
# 8 "safe029_power.opt_pso.opt_rmo.opt.c" 2

# 8 "safe029_power.opt_pso.opt_rmo.opt.c"
void reach_error() { 
# 8 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                    ((void) sizeof ((
# 8 "safe029_power.opt_pso.opt_rmo.opt.c"
                    0
# 8 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
...
# 8 "safe029_power.opt_pso.opt_rmo.opt.c"
                    "0"
# 8 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                    , "safe029_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); }))
# 8 "safe029_power.opt_pso.opt_rmo.opt.c"
                             ; }
...
# 1 "/usr/include/assert.h" 1 3 4
# 14 "safe029_power.opt_pso.opt_rmo.opt.c" 2
...
# 15 "safe029_power.opt_pso.opt_rmo.opt.c" 2
# 36 "safe029_power.opt_pso.opt_rmo.opt.c"
...
{
  pthread_t t2475;
  pthread_create(&t2475, 
# 204 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                        ((void *)0)
# 204 "safe029_power.opt_pso.opt_rmo.opt.c"
                            , P0, 
# 204 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                                  ((void *)0)
# 204 "safe029_power.opt_pso.opt_rmo.opt.c"
  ...
  pthread_t t2476;
  pthread_create(&t2476, 
# 206 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                        ((void *)0)
# 206 "safe029_power.opt_pso.opt_rmo.opt.c"
                            , P1, 
# 206 "safe029_power.opt_pso.opt_rmo.opt.c" 3 4
                                  ((void *)0)
# 206 "safe029_power.opt_pso.opt_rmo.opt.c"
