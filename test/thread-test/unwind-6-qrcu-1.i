...
# 296 "unwind-6-qrcu-1.c" 3 4
             ((void) sizeof ((
# 296 "unwind-6-qrcu-1.c"
             !(1 != 0)
# 296 "unwind-6-qrcu-1.c" 3 4
...
# 296 "unwind-6-qrcu-1.c"
             "!(1 != 0)"
# 296 "unwind-6-qrcu-1.c" 3 4
             , "unwind-6-qrcu-1.c", 296, __extension__ __PRETTY_FUNCTION__); }))
# 296 "unwind-6-qrcu-1.c"
                              ;
...
# 438 "unwind-6-qrcu-1.c" 3 4
             ((void) sizeof ((
# 438 "unwind-6-qrcu-1.c"
             !(1 != 0)
# 438 "unwind-6-qrcu-1.c" 3 4
             ) ? 1 : 0), __extension__ ({ if (
# 438 "unwind-6-qrcu-1.c"
...
# 438 "unwind-6-qrcu-1.c"
             "!(1 != 0)"
# 438 "unwind-6-qrcu-1.c" 3 4
             , "unwind-6-qrcu-1.c", 438, __extension__ __PRETTY_FUNCTION__); }))
# 438 "unwind-6-qrcu-1.c"
                              ;
              __CPROVER_assume(!(1 != 0));
            }
...
# 523 "unwind-6-qrcu-1.c" 3 4
                 ((void) sizeof ((
# 523 "unwind-6-qrcu-1.c"
                 !(ctr1 > 0)
# 523 "unwind-6-qrcu-1.c" 3 4
                 ) ? 1 : 0), __extension__ ({ if (
# 523 "unwind-6-qrcu-1.c"
...
# 523 "unwind-6-qrcu-1.c"
                 "!(ctr1 > 0)"
# 523 "unwind-6-qrcu-1.c" 3 4
                 , "unwind-6-qrcu-1.c", 523, __extension__ __PRETTY_FUNCTION__); }))
# 523 "unwind-6-qrcu-1.c"
                                    ;
...
# 553 "unwind-6-qrcu-1.c" 3 4
                 ((void) sizeof ((
# 553 "unwind-6-qrcu-1.c"
                 !(ctr2 > 0)
# 553 "unwind-6-qrcu-1.c" 3 4
                 ) ? 1 : 0), __extension__ ({ if (
# 553 "unwind-6-qrcu-1.c"
...
# 553 "unwind-6-qrcu-1.c"
                 "!(ctr2 > 0)"
# 553 "unwind-6-qrcu-1.c" 3 4
                 , "unwind-6-qrcu-1.c", 553, __extension__ __PRETTY_FUNCTION__); }))
# 553 "unwind-6-qrcu-1.c"
                                    ;
...
# 580 "unwind-6-qrcu-1.c" 3 4
 ((void) sizeof ((
# 580 "unwind-6-qrcu-1.c"
 0 != 0
# 580 "unwind-6-qrcu-1.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 580 "unwind-6-qrcu-1.c"
...
# 580 "unwind-6-qrcu-1.c"
 "0 != 0"
# 580 "unwind-6-qrcu-1.c" 3 4
 , "unwind-6-qrcu-1.c", 580, __extension__ __PRETTY_FUNCTION__); }))
# 580 "unwind-6-qrcu-1.c"
               ;
}
