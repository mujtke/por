...
import org.sosy_lab.cpachecker.cpa.icintp.ICIntpPrecisionAdjustment;
...
public class PredicateAbstractionManager {
  ...
  public AbstractionFormula buildAbstraction(
    ...
    Set<AbstractionPredicate> icintpPreds = ICIntpPrecisionAdjustment.getCurICIntpPredicates();
    if (icintpPreds != null) {
      remainingPredicates.addAll(icintpPreds);
    }
