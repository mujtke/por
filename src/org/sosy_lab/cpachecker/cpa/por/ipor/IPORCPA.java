...
@Options(prefix = "cpa.ipor")
public class IPORCPA extends AbstractCPA
  ...
  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(IPORCPA.class);
  }

  public IPORCPA(Configuration pConfig, LogManager pLogger, CFA pCfa)
      throws InvalidConfigurationException {
    super("sep", "sep", new IPORTransferRelation(pConfig, pLogger, pCfa));
  ...
  public AbstractState getInitialState(CFANode pNode, StateSpacePartition pPartition)
    ...
    return IPORState.getInitialInstance(
        pNode, cfa.getMainFunction().getFunctionName(), followFunctionCalls);
  }

  @Override
  public PrecisionAdjustment getPrecisionAdjustment() {
    return new IPORPrecisionAdjustment();
  }

  @Override
  public void collectStatistics(Collection<Statistics> pStatsCollection) {
    IPORTransferRelation transferRelation = (IPORTransferRelation) this.getTransferRelation();
