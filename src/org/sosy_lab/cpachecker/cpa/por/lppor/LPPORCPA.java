...
@Options(prefix = "cpa.por.lppor")
public class LPPORCPA extends AbstractCPA
  ...
  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(LPPORCPA.class);
  }

  public LPPORCPA(Configuration pConfig, LogManager pLogger, CFA pCfa)
      throws InvalidConfigurationException {
    super("sep", "sep", new LPPORTransferRelation(pConfig, pLogger, pCfa));
    pConfig.inject(this);
    cfa = pCfa;
  }
  ...
  public AbstractState getInitialState(CFANode pNode, StateSpacePartition pPartition)
    ...
    return LPPORState.getInitialInstance(
        pNode, cfa.getMainFunction().getFunctionName(), followFunctionCalls);
  }

  @Override
  public void collectStatistics(Collection<Statistics> pStatsCollection) {
    LPPORTransferRelation transferRelation = (LPPORTransferRelation) this.getTransferRelation();
